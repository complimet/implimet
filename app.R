        ...
        tabItem(
            ...
            box(
                column(
                    ...
                    p("Ou H, Surendra A, McDowell GSV, Hashimoto-Roth E,  Xia J, Bennett SAL, Cuperlovic-Culf M (2024) Imputation for Lipidomics and Metabolomics (ImpLiMet): Online optimization and method selection for missing data imputation. bioRxives, June, 2024: https://doi.org/10.1101/2024.06.17.599353 "),
                    br(),
                    h3("Public Server"),
